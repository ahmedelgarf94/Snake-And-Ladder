...
int Output::GetCellStartX(const CellPosition & cellPos) const
{
	...
	int StartX;
	StartX= cellPos.HCell()*UI.CellWidth;
	return StartX; // this line should be changed with your implementation
}
...
int Output::GetCellStartY(const CellPosition & cellPos) const
{
	...
	///TODO: implement the following function as described in Output.h file
	int StartY;
	StartY= (cellPos.VCell()*UI.CellHeight)+UI.ToolBarHeight;
	return StartY; // this line should be changed with your implementation
}
...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_COPY_CARD] = "images\\Copy_Menu_Card.jpg";
	MenuItemImages[ITM_CUT_CARD] = "images\\Cut_Menu_Card.jpg";
	MenuItemImages[ITM_PASTE_CARD] = "images\\Paste_Menu_Card.jpg";
	MenuItemImages[ITM_EDIT_CARD] = "images\\Edit_Menu_Card.jpg";
