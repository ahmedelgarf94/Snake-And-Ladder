...
void CardOne::ReadCardParameters(Grid * pGrid)
{
	...
	walletAmount = (walletamount >= 0) ? walletamount : 0;     //the passed number by the user with a small 
...
Card* CardOne::copyparameters(CellPosition pos)
{
	Card* cp = new CardOne(pos);
	((CardOne*)cp)->walletAmount = walletAmount;
	return cp;
